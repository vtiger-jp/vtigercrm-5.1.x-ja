...
/*$mod_list_strings = Array(
	...
	,"birthdate"=>"紹介元"
	,"do_not_call"=>"連絡除外"
	,"email_opt_out"=>"電子メール送信から除外"
	,"primary_address_street_2"=>"番地 2 (主要)"
	,"primary_address_street_3"=>"番地 3 (主要)"
	,"alt_address_street_2"=>"番地 2 (その他)"
	,"alt_address_street_3"=>"番地 3 (その他)"
	,"full_name"=>"姓名"
	,"account_name"=>"顧客企業名"
	,"account_id"=>"顧客企業 ID"
	,"title"=>"タイトル"
	...
	,"yahoo_id"=>"Yahoo! ID"
	,"assistant"=>"アシスタント"
	,"assistant_phone"=>"アシスタント電話"
	,"primary_address_street"=>"番地 (主要)"
	,"primary_address_city"=>"市町村区 (主要)"
	,"primary_address_state"=>"都道府県 (主要)"
	,"primary_address_postalcode"=>"郵便番号 (主要)"
	,"primary_address_country"=>"国 (主要)"
	,"alt_address_street"=>"番地 (その他)"
	,"alt_address_city"=>"市町村区 (その他)"
	,"alt_address_state"=>"都道府県 (その他)"
	,"alt_address_postalcode"=>"郵便番号 (その他)"
	,"alt_address_country"=>"国 (その他)"
	,"description"=>"説明"
